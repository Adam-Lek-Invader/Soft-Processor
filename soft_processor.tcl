...
#
# soft_processor.tcl: Tcl script for re-creating project 'soft_processor'
#
# Generated by Vivado on Sun Oct 19 17:15:21 +0200 2025
...
#
# 1. This project restoration tcl script (soft_processor.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "G:/Temp_FPGA/soft_processor_aaaa/soft_processor.srcs/sources_1/ip/data_ROM/data_ROM.xci"
#    "G:/Temp_FPGA/soft_processor_aaaa/soft_processor.srcs/sources_1/ip/ins_ROM/ins_ROM.xci"
#    "G:/Temp_FPGA/soft_processor_aaaa/soft_processor.srcs/d_mem.v"
#    "G:/Temp_FPGA/soft_processor_aaaa/soft_processor.srcs/i_mem.v"
#    "G:/Temp_FPGA/soft_processor_aaaa/soft_processor.srcs/sources_1/new/Processor_main.v"
#    "G:/Temp_FPGA/soft_processor_aaaa/soft_processor.srcs/sim_1/new/sim_processor.v"
#    "G:/Temp_FPGA/soft_processor_aaaa/data_mem.coe"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/soft_processor.srcs/sources_1/ip/data_ROM/data_ROM.xci"]"\
 "[file normalize "$origin_dir/soft_processor.srcs/sources_1/ip/ins_ROM/ins_ROM.xci"]"\
 "[file normalize "$origin_dir/soft_processor.srcs/d_mem.v"]"\
 "[file normalize "$origin_dir/soft_processor.srcs/i_mem.v"]"\
 "[file normalize "$origin_dir/soft_processor.srcs/sources_1/new/Processor_main.v"]"\
 "[file normalize "$origin_dir/soft_processor.srcs/sim_1/new/sim_processor.v"]"\
 "[file normalize "$origin_dir/data_mem.coe"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "soft_processor"
...
set script_file "soft_processor.tcl"
...
set file "data_ROM/data_ROM.xci"
...
set file "soft_processor.srcs/d_mem.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "soft_processor.srcs/i_mem.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "soft_processor_aaaa/data_mem.coe"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set_property -name "top" -value "Processor_main" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/soft_processor.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/soft_processor.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/soft_processor.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
